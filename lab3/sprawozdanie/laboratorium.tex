...
\section{Rozdzielczoœæ}
Na dok³adnoœæ uzyskanych wyników wp³ywa rodzielczoœæ samego procesu autokorelacji.
Znajdowanie kolejnych wyników autokorelacji odbywa siê poprzez przesuwanie kopii syga³u krok po kroku i sprawdzanie podobieñstwa z sygna³em originalnym.
Tak wiêc rozdzielczoœæ zale¿y od wiekoœci kroku procesu autokorelacji.
Im ten krok jest mniejszy tym rozdzilczoœc wyniku bêdzie wiêksza.

W przypadku tego zadania i jego rozwi¹zania zosta³a zastosowana funkcja \verb|xcorr| pakietu \verb|MATLAB|.
Jeden krok mia³ d³ugoœæ $\frac{1}{30} \approx \num{0.0333}$, co oznacza, ¿e z tak¹ dok³adnoœci¹ zaosta³a zmierzona czêstotliwoœæ w Hz.
Na têtno mierzone w uderzeniach na minutê prze³o¿y³o siê to na dok³adnoœæ do $\frac{60}{30} = \num{2}$ bmp.
